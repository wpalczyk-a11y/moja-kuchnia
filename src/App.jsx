...
const RECIPES = [
  ...
  { id:9, name:"Bułki do burgerów / hot dogów", emoji:"🍞", cat:"Piekarnia", time:"30 min + 2h wyrastanie", srv:8, diff:"Średni", kcal:"~220 kcal", prot:"~6g", desc:"Miękkie bułki na drożdżach z dodatkiem skrobi ziemniaczanej — wychodzą puszyste i lekko maślane. Opcjonalnie jak brioche jeśli użyjesz mleka.",
    ing:[{n:"Mąka pszenna",a:"400",u:"g"},{n:"Skrobia ziemniaczana",a:"42",u:"g"},{n:"Cukier",a:"25",u:"g"},{n:"Sól",a:"8",u:"g"},{n:"Drożdże instant (w proszku)",a:"6",u:"g"},{n:"Masło miękkie",a:"50",u:"g"},{n:"Woda lub mleko (mleko = bardziej brioche)",a:"225",u:"g"},{n:"Jajko",a:"1",u:"szt"},{n:"Białko jajka do posmarowania (opcja)",a:"1",u:"szt"},{n:"Mak do posypania (opcja)",a:"",u:"do smaku"},{n:"Masło roztopione do posmarowania po wypieku",a:"20",u:"g"}],
    eq:["Misa do wyrabiania lub mikser z hakiem","Waga kuchenna","Blacha do pieczenia","Papier do pieczenia","Piekarnik"],
    mise:["Odmierz wszystkie składniki przed startem — drożdże, mąkę, skrobię, cukier, sól do osobnych miseczek","Masło wyjmij z lodówki 30 min wcześniej — ma być miękkie, nie roztopione","Jeśli używasz drożdży instant — aktywuj je: podgrzej 50g wody/mleka do 30°C (ciepłe ale nie gorące — gorące zabije drożdże), wymieszaj z 6g drożdży i 1 łyżeczką cukru, odstaw 5-10 min aż zacznie się pienić","Przygotuj blachę wyłożoną papierem do pieczenia","Piekarnik z włączoną tylko lampką nadaje się jako ciepłe miejsce do wyrastania (~28-30°C)"],
    steps:[{s:1,t:"Misa lub mikser z hakiem",a:"Wrzuć do misy: 400g mąki, 42g skrobi, 25g cukru, 8g soli. Wymieszaj suche składniki. Dodaj aktywowane drożdże, resztę wody/mleka (175g), 1 jajko i 50g miękkiego masła. Wyrabiaj ręcznie 8 min lub mikserem na haczyku 5 min. Ciasto gotowe gdy jest gładkie, elastyczne i lekko się klei — nie dosypuj mąki, ta kleistość jest prawidłowa."},{s:2,t:"Misa przykryta folią",a:"Uformuj kulę, włóż do naoliwionej misy, przykryj folią lub ściereczką. Wstaw do ciepłego miejsca (np. piekarnik z lampką) na 60 min. Ciasto powinno podwoić objętość."},{s:3,t:"Blat + waga",a:"Wyłóż ciasto na lekko oprószony blat. Podziel na 8 równych porcji po 90-95g każda — użyj wagi. Uformuj kulki i zostaw pod ściereczką na 3 min (odpoczynek ułatwia formowanie)."},{s:4,t:"Blat — formowanie",a:"Każdą kulkę lekko podsyp mąką i spłaszcz dłonią na placek. Zawiń ciasto 2-3 razy do środka żeby napiąć powierzchnię. Roluj pod lekkim uciskiem na podłużny kształt (hot dog) lub zostaw okrągły (burger). Ważne: napięta gładka powierzchnia na wierzchu = ładna skórka po wypieku."},{s:5,t:"Blacha z papierem",a:"Układaj bułki w odległości 1-2 cm od siebie. Pierwsza i ostatnia w rzędzie powinna mieć oparcie o brzeg blachy lub inną bułkę — inaczej się zniekształci. Przykryj ściereczką i odstaw na 60 min do ponownego wyrośnięcia. Mają urosnąć wyraźnie i skleić się boki."},{s:6,t:"Piekarnik 175°C",a:"Nagrzej piekarnik do 175°C (grzałka góra-dół). Opcjonalnie posmaruj bułki roztrzepanym białkiem jajka i posyp makiem. Piecz 15-16 min aż złoto-brązowe. Po wyjęciu od razu posmaruj roztopionym masłem (20g) — to daje miękką, błyszczącą skórkę."}]},
